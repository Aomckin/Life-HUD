...
@Service public final class FocusService {
    ...
    public synchronized FocusSessionView manual(FocusManualRequest r){
        ...
        save(s); event(LifeEventType.FOCUS_FINISHED,s,"补录铁幕 · "+format(seconds)); return view(s,now);
    }
