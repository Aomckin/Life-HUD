 ...
 * id + snapshot title so later renames or edits never rewrite history.
 */
public record NowSnapshot(String id, String stageTitle, String theme, List<NowItem> favoriteSongs,
