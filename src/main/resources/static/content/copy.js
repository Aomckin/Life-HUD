...
export const taskCopy = {
  title: "任务 · Tasks",
  allDoneToday: "今天的行动都完成了。",
  dailyTitle: "每日任务 · Daily",
  specialTitle: "特别行动 · Special",
  dailyTag: "每日",
  specialTag: "特别行动",
  doneBadge: "今日已完成",
  completeLabel: "完成",
  completedToast: "完成，记下来了",
  completedFoldLabel: "今天完成了",
  dailyEmpty: "今天还没有固定日常。",
  specialEmpty: "还没有特别行动。去做一点和平常不一样的事吧。",
  emptyTasks: "今天还没有要做的任务。",
  linkEdit: "编辑方向",
  linkTitle: "关联方向",
