...
public final class GrowthAchievementService {
    ...
    public GrowthAchievementService(Player player,GrowthRecordRepository records,LevelService levels,JsonFileStore files,GrowthStatsService stats,GrowthCatalog catalog,GrowthCopy copy){this.player=player;this.records=records;this.levels=levels;this.files=files;this.stats=stats;this.catalog=catalog;this.copy=copy;}
