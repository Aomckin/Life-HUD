...
export const taskCopy = {
  ...
  allDoneInPool: "这一组今天都完成了。",
  linkEdit: "编辑方向",
  poolEntry: "管理任务池 →",
  poolTitle: "任务池 · Task Pool",
  poolHint: "任务定义与模板。主页面只显示今天实际激活的任务。",
  poolDailyTitle: "Daily 模板",
  poolSpecialTitle: "Special 模板",
  poolAdd: "＋ 新增",
  poolEdit: "编辑",
  poolDelete: "删除",
  poolDeleteConfirm: "删除这条任务定义？相关今日实例与历史记录不受影响。",
  poolEnabled: "启用",
  poolDisabled: "已停用",
  backToTasks: "← 返回行动台",
  nameLabel: "任务名称",
  noteLabel: "小注释",
  notePlaceholder: "补充一句执行提示（可选）",
  energyLabel: "Energy 奖励",
  specialExpLabel: "EXP 奖励",
  linkTitle: "关联方向",
