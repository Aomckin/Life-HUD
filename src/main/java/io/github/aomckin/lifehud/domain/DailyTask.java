...
public final class DailyTask {
    ...
    public Map<String,Object> toMap(){Map<String,Object> m=new LinkedHashMap<>();m.put("id",id);m.put("name",name);m.put("reward",reward);m.put("exp",exp);m.put("created_time",createdTime.format(FORMAT));m.put("completed_count",completedCount);m.put("done",done);m.put("dreamId",dreamId);m.put("goalId",goalId);m.put("dreamMilestoneId",dreamMilestoneId);return m;}
