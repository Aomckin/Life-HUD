...
class ArchitectureTest {
 ...
 @Test void webUiUsesShellAndDedicatedGrowthPage()throws Exception{String shell=Files.readString(Path.of("src/main/resources/static/v0.2.html"));String routes=Files.readString(Path.of("src/main/resources/static/modules/navigation.js"));String growth=Files.readString(Path.of("src/main/resources/static/pages/growth.js"));assertThat(shell).contains("Life HUD v0.6.2","growth.css","direction.css");assertThat(routes).contains("/dashboard","/focus","/growth");assertThat(growth).contains("Achievements","Milestones","Titles").doesNotContain("Coin","Shop");}
