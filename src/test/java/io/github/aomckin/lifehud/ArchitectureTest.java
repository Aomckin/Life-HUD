...
class ArchitectureTest {
 ...
 @Test void webUiUsesShellAndDedicatedGrowthPage()throws Exception{String shell=Files.readString(Path.of("src/main/resources/static/v0.2.html"));String routes=Files.readString(Path.of("src/main/resources/static/modules/navigation.js"));String growth=Files.readString(Path.of("src/main/resources/static/pages/growth.js"));assertThat(shell).contains("Life HUD v0.6.1","growth.css","direction.css");assertThat(routes).contains("/dashboard","/focus","/growth");assertThat(growth).contains("Achievements","Milestones","Titles").doesNotContain("Coin","Shop");}
 @Test void wideCanvasPagesSpanAllTwelveColumns()throws Exception{String shell=Files.readString(Path.of("src/main/resources/static/styles/shell.css"));assertThat(shell).contains("#page > .life-page","#page > .timeline-page","grid-column: 1 / -1");}
